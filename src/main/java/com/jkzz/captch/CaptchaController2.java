...
@RestController
public class CaptchaController2 extends BaseController {
    ...
    public static byte[] water(int x, int y, int width, int height, String sourcePath) {
        ...
        try {
            ...
            //BufferedImage appendImage = ImageIO.read(new File("E:/test/beta/test2.jpg"));
    ...
    public static void main(String[] args) {
        ...
        //int num = (int) (Math.random() * 8 + 1);//选择随机图片
        //String captchaPath = "E:/test/"+num+".jpg";
        String captchaPath = "E:/test/103.jpg";
