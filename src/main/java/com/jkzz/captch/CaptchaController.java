...
public class CaptchaController {
    ...
    public static byte[] water(int x, int y, int width, int height, String sourcePath) {
        ...
        try {
            ...
            //BufferedImage appendImage = ImageIO.read(new File("E:/test/beta/pach393933.png"));
           BufferedImage appendImage = ImageIO.read(new File("E:/test/beta/999.png"));

            g.setComposite(AlphaComposite.getInstance(AlphaComposite.SRC_OVER, 0.5f));
            //g.drawImage(water, x, y, width, height, null);
            g.drawImage(appendImage, x, y, appendImage.getWidth(), appendImage.getHeight(), null);
            g.dispose();

            ImageIO.write(image, "jpg", new File("E:/test/beta/18.jpg"));
    ...
    public static byte[] cut(int x1, int y1, int width, int height, String sourcePath) {
        ...
        try {
            ...
            ImageIO.write(bi, "jpg", new File("E:/test/beta/test3.jpg"));
            ByteArrayOutputStream out = new ByteArrayOutputStream();
